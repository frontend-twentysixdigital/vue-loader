...
module.exports = function genStyleInjectionCode (
  ...
  const isValidLocale = style => !style.attrs || !style.attrs.locale || style.attrs.locale === options.defaultLocale || style.attrs.locale === options.locale
  ...
  if (!needsExplicitInjection) {
    styles.forEach((style, i) => {
      ...
      if (isNotEmptyStyle(style) && isValidLocale(style)) {
